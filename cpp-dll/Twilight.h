...
class Twilight {
  public:
    ...
    double longitude;     // Longitude of that location; it decides which local day
                          // the daylight duration below is measured over.
    ...
    void calculate(double latitude, double longitude, double angle, time_t t);

  private:
    double dayFraction(double z, double angle);
